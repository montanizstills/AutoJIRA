...
def read_all_team(url, headers, auth, org_id, team_id):
...
def add_all_members(url, headers, auth, org_id, team_id, data):
...
def delete_all_team(url, headers, auth, org_id, team_id, data):
